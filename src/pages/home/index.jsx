    ...
    return (
        <div className="flex flex-col items-center justify-center mt-20 mb-20">
            <div className="text-center mb-12 ">
                <h1 className="text-5xl font-extrabold mb-4 text-stroke">
                    Welcome to <span className="text-primary">HRnet</span>
                </h1>
                <p className="text-lg">Your human resources management platform.</p>
            </div>

            <div className="rounded-xl border border-border bg-card text-card-foreground shadow-lg flex-[2] p-6">
